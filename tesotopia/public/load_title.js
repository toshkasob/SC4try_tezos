...
class gamePlanet {
    constructor(id,name,r,pos) {
        ...
        if (id !== 0) {
            this.prevObject = new previewObject(name,r - 0.1,pos);            
            this.isPrev = false;     
...
var object = [
     ...
     new gamePlanet(2,"Beta_3PR_FS", 1.9,  positions[2]),
     new gamePlanet(3,"Gamma_2TT",   1.8,  positions[3]),
     new gamePlanet(4,"Theta_345",   1.7,  positions[4]),
