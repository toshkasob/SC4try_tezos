...
window.onload=function() {
    ...
    if(gl){
        ...
        var positions = [ new Point3D(0,0,0), new Point3D(0.0,0.0,-10.0) ];
        var object = [ new gamePlanet("test",10,positions[0]), new gamePlanet("test2",0.5,positions[1]) ];

        for (let i=0; i< object.length; i++) {
            object[i].initBuffers();
            object[i].setTexture("https://dl.dropboxusercontent.com/s/0yvevurie5uci6r/RedBrick_256.png");
        }
